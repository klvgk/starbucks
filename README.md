...
## :memo: Descrição
Projeto é um website da cafeteria Starbucks, que utiliza elementos de Flexbox e Grid.
<br><br>

## :books: Funcionalidades
* Mostrar de forma estilizada os seus produtos, destacando a ideologia da marca Starbucks.
<br>
...
```
git clone https://github.com/klvgk/starbucks
```
